...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        productDataStore.add(new Product("iPhone XR", 749, "USD", "The phone has a 6.1-inch 'Liquid Retina' LCD display, which Apple claims is the most advanced LCD in the industry.", tablet, apple));
    }
}
